...
\]
It may be shown that the solution to this problem
always exists and is unique, see \cite{CoroianuETALXXXX:piecewise1}
and \cite{CoroianuETALXXXX:piecewise2}.

The \str{"{}NearestEuclidean"{}} \argument{method}
uses the algorithm described in \cite{CoroianuETALXXXX:piecewise1}
and \cite{CoroianuETALXXXX:piecewise2}.
...
It may be shown, see \cite{CoroianuETALXXXX:piecewise1},
