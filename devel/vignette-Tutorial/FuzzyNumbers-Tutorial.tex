...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
alpha <- \hlfunctioncall{c}(0.2, 0.3, 0.5, 0.6, 0.9)
P3 <- \hlfunctioncall{as.PiecewiseLinearFuzzyNumber}(T1,
         knot.n=5, knot.alpha=alpha)
P3
\end{alltt}
\begin{verbatim}
## Piecewise linear fuzzy number with 5 knot(s),
##    support=[1,7],
##       core=[1.5,4].
\end{verbatim}
\begin{alltt}
\hlfunctioncall{plot}(P3)
...
\hlfunctioncall{text}(7, alpha, \hlfunctioncall{sprintf}(\hlstring{'a=%g'}, alpha), pos=3)
\end{alltt}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
## 0.819360481     60 0.545856269 0.022293594
## 0.326543073     17 0.546145664 0.022294007
## 0.102972513     35 0.545856297 0.022293594
## 0.129096587      8 0.546262450 0.022294032
## 0.877980422     14 0.546147795 0.022294007
\end{verbatim}
\end{kframe}
\end{knitrout}
