...
\hlstd{)}
\hlkwd{plot}\hlstd{(B,} \hlkwc{xlab}\hlstd{=}\hlstr{'$x$'}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{'$\textbackslash{}\textbackslash{}alpha$'}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlkwd{plot.default}\hlstd{(}\hlnum{NA}\hlstd{,} \hlkwc{xlab}\hlstd{=}\hlstr{'$x$'}\hlstd{,} \hlkwc{ylab}\hlstd{=}\hlstr{'$\textbackslash{}\textbackslash{}mu_S(x)$'}\hlstd{,}
...
\hlstd{xlab} \hlkwb{<-} \hlkwd{c}\hlstd{(}\hlstr{'$s_1$'}\hlstd{,} \hlstr{'$s_2$'}\hlstd{,} \hlstr{'$s_3$'}\hlstd{,}
          \hlstr{'$s_4$'}\hlstd{,} \hlstr{'$s_5$'}\hlstd{,} \hlstr{'$s_6$'}\hlstd{)}
...
\hlkwd{text}\hlstd{(}\hlnum{5.55}\hlstd{, X[}\hlstr{'knot.alpha'}\hlstd{],} \hlkwd{sprintf}\hlstd{(}\hlstr{'$\textbackslash{}\textbackslash{}alpha_0$'}\hlstd{),} \hlkwc{pos}\hlstd{=}\hlnum{4}\hlstd{,} \hlkwc{xpd}\hlstd{=}\hlnum{TRUE}\hlstd{)}
...
{\centering \includegraphics[width=4.5in]{figures-knitr/additionFig} 
...
\hlkwd{plot}\hlstd{(}\hlkwd{fapply}\hlstd{(A,} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)} \hlkwd{log}\hlstd{(x}\hlopt{+}\hlnum{1}\hlstd{)}\hlopt{^}\hlnum{0.5}\hlstd{))}
\end{alltt}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=4.5in]{figures-knitr/fapplyFig} 
...
{\centering \includegraphics[width=4.5in]{figures-knitr/ApproxPLFNNearestConv2} 
...
{\centering \includegraphics[width=4.5in]{figures-knitr/ApproxPLFNNearest4} 
...
\end{alltt}
\begin{verbatim}
## 0.416650999     21 *0.363075991* 0.650344602
## 0.969824721     23 *0.363016625* 0.650345262
## 0.619480287     34 *0.362899271* 0.650336546
## 0.167719480     43 *0.363064000* 0.650343721
## 0.736245882     23 *0.363006878* 0.650345243
\end{verbatim}
\end{kframe}
\end{knitrout}
...
{\centering \includegraphics[width=4.5in]{figures-knitr/suppcoreplfn1a3} 
...
{\centering \includegraphics[width=4.5in]{figures-knitr/suppcoreplfn1a5} 
